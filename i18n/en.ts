export default {
  ...
  moduleManager: {
    ...
    description: "Manage your custom modules and prompts",
  ...
  transformations: {
    ...
    effects: {
      streetViewFromMap: { title: "Street View from Map", description: "Generates a ground-level photo from a map with a directional arrow." },
      sceneFromMultipleImages: { title: "Scene from Multiple Images", description: "Combines elements from several images into a single, cohesive scene." },
      autoEnhance: { title: "Auto Enhance", description: "Automatically improves the color, contrast, and lighting of your photo." },
      characterSheet: { title: "Character Sheet", description: "Creates a professional character design sheet, including different views and expressions." },
      hairstyleGrid: { title: "Hairstyle Grid", description: "Shows your subject with nine different hairstyles in a grid." },
      dishFromIngredients: { title: "Dish from Ingredients", description: "Whips up a delicious-looking meal from a photo of raw ingredients." },
      virtualTryOn: { 
        title: "Virtual Try-On", 
        description: "Puts the clothing from a reference image onto your character.",
        uploader1Title: "Character",
        uploader1Desc: "The person to dress.",
        uploader2Title: "Clothing",
        uploader2Desc: "The outfit to wear."
      },
      multiViewModel: { title: "Multi-View Model", description: "Generates front, back, and side views of an object, like a 3D model sheet." },
      movieStoryboard: { title: "Movie Storyboard", description: "Creates a 12-panel cinematic storyboard from your image." },
      redPenCritique: { title: "Red Pen Critique", description: "Analyzes your image and marks areas for improvement with a red pen." },
      isometricFromMap: { title: "Isometric from Map", description: "Transforms a map into a game-like isometric view." },
      virtualMakeup: {
        title: "Virtual Makeup",
        description: "Applies a makeup style from a reference photo to your subject.",
        uploader1Title: "Person",
        uploader1Desc: "The person to apply makeup to.",
        uploader2Title: "Makeup Style",
        uploader2Desc: "The makeup reference."
      },
      gundamModel: { title: "Gundam Model Kit", description: "Reimagines your character as a detailed Gundam model kit, complete with box art." },
      foodCalorieAnnotation: { title: "Calorie Counter", description: "Annotates a photo of a meal with its estimated calorie count." },
      imageOutpainting: { title: "Image Outpainting", description: "Intelligently fills in the missing (checkered) parts of an image." },
      sceneFromAncientMap: { title: "Scene from Ancient Map", description: "Creates a photorealistic scene from an ancient or old map." },
      fashionMoodboard: { title: "Fashion Moodboard", description: "Designs a stylish fashion collage or moodboard from your image." },
      itashaCar: { title: "Anime Car Wrap (Itasha)", description: "Applies your character's image to a sports car in the 'itasha' style." },
      floorplan3d: { title: "3D from Floorplan", description: "Renders a realistic 3D architectural model from a 2D floorplan." },
      idPhoto: { title: "ID Photo", description: "Converts your portrait into a professional 2-inch ID photo with a blue background." },
      pirateWantedPoster: { title: "Pirate Wanted Poster", description: "Turns your photo into an old, weathered pirate wanted poster." },
      lineArtToDoodle: { title: "Child's Drawing Style", description: "Redraws your image in the charming, naive style of a young child's crayon drawing." },
      becomeVtuber: { title: "VTuber Stream Overlay", description: "Creates a complete VTuber streaming interface using your character." },
      makeMoviePoster: { title: "Movie Poster", description: "Automatically designs a cinematic movie poster from your photo, complete with a title and credits." },
      fisheyeLens: { title: "Fisheye Lens", description: "Applies a dramatic, distorted fisheye lens effect." },
      customClawMachine: { title: "Claw Machine", description: "Turns your subject into a cute plushie and places it inside a claw machine." },
      pixarStyle: { title: "Pixar Style Character", description: "Renders your portrait in the beloved 3D style of a Pixar character." },
      figurineDesign: { title: "Popular Figurine", description: "Instantly generate a detailed collectible figurine! Hot!" },
      photoFix: { title: "Old Photo Restoration", description: "Restore old photos with one click! Professional! Stunning!" },
      homeDesign: { title: "Interior Designer", description: "Complete your interior design just by talking!" },
      noirComicPanel: { title: "Noir Comic Panel", description: "High-contrast B&W ink, rainy night detective & neon bar, dramatic lighting, atmospheric widescreen." },
      miniatureProductAd: { title: "Miniature Product Ad", description: "High-end commercial still life: pure white background, soft studio lighting, shallow depth of field, highlighting a tiny but detailed product." },
      kawaiiSticker: { title: "Kawaii Sticker", description: "Kawaii style, thick outlines, simple cel-shading, vibrant colors, pure white background." },
      amigurumiCrochet: { title: "Amigurumi Crochet Doll", description: "Hyper-realistic crochet amigurumi doll with a professional studio shot effect." },
      lineArtExtraction: { title: "Detailed Line Art", description: "Precisely trace and generate pure line art." },
      emotionGrid16: { title: "16-Panel Emotion Grid", description: "Generate a cartoon grid with 16 different emotions in one click! Super fun!" },
      marbleStatue: { title: "Marble Statue", description: "Convert an illustration into a museum-quality marble statue." },
      vintageTinToy: { title: "Vintage Tin Toy", description: "Nostalgic wind-up tin toy style with a retro, weathered texture." },
      waterDropletReflection: { title: "Water Droplet Reflection", description: "Your uploaded image perfectly reflected in a crystal-clear water droplet on a green leaf, with natural lighting effects." },
      memePack: { title: "Meme Pack", description: "Generate a 4-panel meme pack showing four different expressions: joy, anger, sadness, and happiness, on a solid color background." },
      knittedDoll: { title: "Knitted Doll", description: "Create a cute, Q-version knitted doll of your character, gently held in two hands." },
      desktopFigurine: { title: "Desktop Figurine", description: "Turn your character into a hyper-realistic PVC anime figurine on a desk." },
      giantDoll: { title: "Giant Doll", description: "Pose next to a giant, stylized doll version of yourself in a modern art gallery." },
      flatLay: { title: "Outfit Flat Lay", description: "Display all clothing items from the image in a flat lay photograph." },
      commercialPhoto: { title: "Commercial Photoshoot", description: "Transform your character into a high-fashion commercial star, with automatic adjustments to clothing, makeup, and background." },
      ...
      expressionReference: {
        ...
        description: "Applies an expression from one image to a character in another.",
        uploader1Title: "Character",
        uploader1Desc: "The character whose expression will be changed.",
        uploader2Title: "Expression Reference",
        uploader2Desc: "The image with the expression to apply."
      },
      ...
      minimalistIllustration: { title: "Minimalist Illustration", description: "Turn one to four photos into a cute, black and white minimalist illustration. Each person will be drawn with unique characteristics and a fitting prop, arranged in a grid." },
